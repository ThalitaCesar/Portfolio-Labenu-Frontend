            ...
            return(
                    ...
                    <ContainerInfoExperiences>
                        ...
                        <span style={{color: "#FEA55F"}}>&#123; </span>
                         ...
                         <span style={{color: "#43D9AD"}}> LinguagensEFerramentas: </span> <span style={{color: "#C98BDF"}}>'React, typescript, styled-components, material Ui, graphQl, <br></br> mongodb, postgresql, docker, figma, trello, etc... ' </span>,  <br></br>
