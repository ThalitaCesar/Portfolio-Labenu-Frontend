...
var ButtonBase = React12.forwardRef(function ButtonBase2(props, ref) {
  ...
  }, buttonProps, other), children2, enableTouchRipple ? React12.createElement(TouchRipple_default, _extends({
    ref: rippleRef,
    center: centerRipple
...
var Button = React13.forwardRef(function Button2(props, ref) {
  ...
  var startIcon = startIconProp && React13.createElement("span", {
    className: clsx_m_default(classes.startIcon, classes["iconSize".concat(capitalize(size))])
  }, startIconProp);
  var endIcon = endIconProp && React13.createElement("span", {
